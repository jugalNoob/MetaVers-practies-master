...
<br />
<input type="text" name="" id=""    onChange={(e)=>setHeight(e.target.value)} placeholder='enter a width'/>
<br />
<input type="text" name="" id=""   onChange={(e)=>setWidth(e.target.value)} placeholder='enter a height'/>
<br />
<input type="text" name="" id=""   onChange={(e)=>setDepth(e.target.value)}  placeholder='enter a depth'/>
<br />
<input type="text" name="" id=""   onChange={(e)=>setNft_x(e.target.value)} placeholder='enter a x'/>
<br />
<input type="text" name="" id=""   onChange={(e)=>setNft_Y(e.target.value)} placeholder='enter a y'/>
<br />
<input type="text" name="" id=""   onChange={(e)=>setNft_Z(e.target.value)}  placeholder='enter a z'/>
<br />
<button onClick={Mintes}>mints</button>
